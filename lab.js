...
//Code here
console.log(dog.name, dog.color, dog.age, dog.goodBoy)
...
/*
  ...
  and change the value of the book key in your 
...
let whiskers = new Cat("Whiskers", 100, "pink")
...
let dumbledore = new Wizard(`Dumbledore`, 80, `DieDude`)
...
/*
    ...
    Phone will build phone objects with brand, model, storage, color, price, and 
    sold properties.
...
//Code Here
let iPhone = new Phone(`Apple`, `iPhone`, 128, `Space Gray`, 1000)
let samsusng = new Phone(`Samsung`, `Galaxy`, 500, `Black`, 999)
let google = new Phone(`Google`, `Pixel`, 500, `white`, 799 )
/* 
...
/*
  ...
  how to use it. Challenge yourself by going online and researching what the 
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(2, `White`, 3000, `Honda`, `yes`)
/*
  Call the move function on myFirstMotorcycle (don't forget the parameter)
*/
myFirstVehicle.move(3000)
...
/*
  ...
  take in
  all the same arguments as Vehicle plus 3 new ones: name 
  (boats gotta have cool names), type (ski boat, yacht, etc), and isSeaworthy.
...
//Code Here
let theBoat = new Boat(50, 'Black', 300, 'Nautique', 'yes', 'the boat', 'surf', '')
console.log(theBoat)
/*
...
//Code Here
theBoat.checkSeaworthiness()
/*
  Now run the performMaintenance method on your boat
*/

//Code Here 
theBoat.performMaintenance()
/*
